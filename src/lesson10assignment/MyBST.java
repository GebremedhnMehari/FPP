...
public class MyBST {
	...
	public boolean find(Integer x) {//Employee
		if(x==null) return false;
		return find(x,root);
	}
	private boolean find(Integer x, Node n){  //Employee
	...
	public void insert(Integer x) {   //Employee
		if (root == null) {
	...
	private class Node {
		...
		// Constructors
		Node(Integer theElement) {     //Employee
			this(theElement, null, null);
		}

		Node(Integer element, Node left, Node right) {     //Employee
			this.element = element;
			this.left = left;
			this.right = right;
		}
		private Integer element; // The data in the node       //Employee
